...
#### config apache2
/etc/apache2/sites-enabled/gitlab.conf
	...
	<VirtualHost *:80>
	  ...
	  <Location />
	    ...
	    ProxyPassReverse http://gitlab.zhuxy.com/
	  </Location>
	  ...
	  ErrorLog  /var/log/apache2/gitlab.zhuxy.com_error.log
	  CustomLog /var/log/apache2/gitlab.zhuxy.com_forwarded.log common_forwarded
	  CustomLog /var/log/apache2/gitlab.zhuxy.com_access.log combined env=!dontlog
	  CustomLog /var/log/apache2/gitlab.zhuxy.com.log combined
...
More in [GitLab](https://github.com/gitlabhq/gitlabhq/blob/master/doc/install/installation.md)
